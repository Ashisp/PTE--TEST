        ...
        <div class="col-md-10 col-md-offset-1">
            ...
            <form action="" method="post">
                <div class="userspace col-md-5">
                    ...
                    <input type="checkbox" name="choice" value="v1"> Answer 1<br/>
                    <input type="checkbox" name="choice" value="v1"> Answer 2<br/>
                    <input type="checkbox" name="choice" value="v1"> Answer 3<br/>
                    <input type="checkbox" name="choice" value="v1"> Answer 4<br/>
                </div>
                <div>
