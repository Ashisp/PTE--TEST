...
/** Function that will automatically turn the microphone and sets the recording volume to max **/
var turnMicrophoneOn = function(){
	microphoneLevel.gain.value = 1;
	$record.attr('disabled', false);
	$("#turnOn").attr("disabled", true);
	var option = ENCODING_OPTION['mp3'];
	if (microphone == null)
